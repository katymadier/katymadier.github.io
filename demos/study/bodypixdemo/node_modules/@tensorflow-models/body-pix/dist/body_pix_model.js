                ...
                switch (_b.label) {
                    case 0:
                        ...
                        segmentation = tf.tidy(function () {
                            var _a = util_1.resizeAndPadTo(input, segmentationModelImageDimensions), resizedAndPadded = _a.resizedAndPadded, paddedBy = _a.paddedBy;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    tf.util.assert(typeof multiplier === 'number', "got multiplier type of " + typeof multiplier + " when it should be a " +
                        "number.");
                    tf.util.assert(possibleMultipliers.indexOf(multiplier.toString()) >= 0, "invalid multiplier value of " + multiplier +
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, tf.loadFrozenModel(baseUrl + "tensorflowjs_model.pb", baseUrl + "weights_manifest.json")];
                case 1:
                    model = _a.sent();
